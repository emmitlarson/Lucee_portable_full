...
!macro CustomCodePostInstall
	Rename "$INSTDIR\jre1.8.0_161\bin" "$INSTDIR\bin"
	Rename "$INSTDIR\jre1.8.0_161\lib" "$INSTDIR\lib"
	Rename "$INSTDIR\jre1.8.0_161\COPYRIGHT" "$INSTDIR\COPYRIGHT"
	Rename "$INSTDIR\jre1.8.0_161\LICENSE" "$INSTDIR\LICENSE"
	Rename "$INSTDIR\jre1.8.0_161\README.txt" "$INSTDIR\README.txt"
	Rename "$INSTDIR\jre1.8.0_161\release" "$INSTDIR\release"
	Rename "$INSTDIR\jre1.8.0_161\THIRDPARTYLICENSEREADME.txt" "$INSTDIR\THIRDPARTYLICENSEREADME.txt"
	Rename "$INSTDIR\jre1.8.0_161\THIRDPARTYLICENSEREADME-JAVAFX.txt" "$INSTDIR\THIRDPARTYLICENSEREADME-JAVAFX.txt"
	Rename "$INSTDIR\jre1.8.0_161\Welcome.html" "$INSTDIR\Welcome.html"
	RMDir "$INSTDIR\jre1.8.0_161"
